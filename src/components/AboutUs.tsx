  ...
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div 
          ref={statsRef}
          className={`bg-gradient-to-r from-orange-500/10 to-orange-600/10 backdrop-blur-sm p-12 rounded-3xl border border-orange-500/20 transition-all duration-800 ${
            statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-800 ${
              statsVisible ? 'animate-fade-in-left' : ''
            }`}>
            ...
            <div className={`grid grid-cols-2 gap-6 transition-all duration-800 ${
              statsVisible ? 'animate-fade-in-right' : ''
            }`}>
              <div className={`bg-white/5 p-6 rounded-xl border border-white/10 transition-all duration-300 hover:scale-105 ${
